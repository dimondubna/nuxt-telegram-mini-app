...
const tasks = [
    ...
    { title: 'Subscribe Youtube', description: 'Earn 50 tokens for subscribe', icon: 'https://depintech.org/network.png', link: 'https://youtube.com/@depintech/', buttonText: 'Subscribe' },
